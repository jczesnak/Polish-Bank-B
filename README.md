...
| Swagger UI | https://www.google.com/search?q=http://localhost:8000/api/schema/swagger-ui/ |
...
## Dokumentacja
  ...
  - [Backlog — GitHub Projects / Trello](https://www.google.com/search?q=%23) — uzupełnij link
  - [Swagger UI](https://www.google.com/search?q=http://localhost:8000/api/schema/swagger-ui/) — po uruchomieniu aplikacji
